...
export function ServiceHorizontalCard({
    ...
    return (
        <div className={cn(
            ...
            "hover:bg-[#F3F9FF] hover:border-[#D0E5FF] hover:shadow-md sm:h-[240px]",
            className
        )}>
            {/* Image Container - Flip effect */}
            <div className="flex-shrink-0 [perspective:1000px] z-10">
                <div className="w-[150px] h-[150px] rounded-lg overflow-hidden shadow-sm relative transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <img
                        src={imageUrl}
                        alt={title}
