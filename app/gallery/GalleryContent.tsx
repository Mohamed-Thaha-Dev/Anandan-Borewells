...
const galleryImages = [
    { src: "/assets/images/gallery/gallery image-1.png", alt: "Drilling Site 1" },
    { src: "/assets/images/gallery/Gallery img -2.png", alt: "Drilling Site 2" },
    { src: "/assets/images/gallery/gallery img-3.png", alt: "Drilling Site 3" },
    { src: "/assets/images/gallery/Gallery img-4.png", alt: "Drilling Site 4" },
    { src: "/assets/images/gallery/Gallery img-5.png", alt: "Drilling Site 5" },
    { src: "/assets/images/gallery/Gallery img-6.png", alt: "Drilling Site 6" },
    { src: "/assets/images/gallery/gallery img-7.png", alt: "Drilling Site 7" },
    { src: "/assets/images/gallery/gallery img-8.png", alt: "Drilling Site 8" },
];
    ...
    return (
        <main>
            <SubHero
                ...
                backgroundImage="/assets/images/hero/hero-2.png"
            />
