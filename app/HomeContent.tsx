...
import { Phone, ArrowRight, Search, MapPin, Drill, CheckCircle, Clock, Settings, IndianRupee, ShieldCheck, Heart, FileCheck, Star } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-white/30">
                    {stats.map((stat, index) => (
                        <div key={index} className="flex flex-col items-center justify-center py-2">
                            <span className="block text-3xl md:text-5xl font-extrabold text-[#FFC107] mb-1">{stat.value}</span>
                            <span className="text-white text-sm md:text-lg font-medium">{stat.label}</span>
                        </div>
                    ))}
                </div>
            </div>
...
function Hero() {
    ...
    return (
        <section id="home" className="relative min-h-screen lg:max-h-screen flex items-center pt-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-20 mt-13 text-white flex flex-col items-center justify-center min-h-screen">
                <div className="max-w-3xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 bg-[#005f99]/60 px-4 py-1.5 rounded-full mb-6 border border-white/20 shadow-md">
                        ...
                        <span className="text-white/90 text-sm font-medium tracking-wide">Chennai Trusted Borewell Service</span>
                    </div>

                    <h1 className="text-[28px] md:text-4xl lg:text-5xl font-bold mb-3 leading-tight text-white">
                        Anandan Borewells
                    </h1>

                    <h2 className="text-lg md:text-3xl lg:text-4xl font-bold mb-5 text-[#FFC107]">
                        Your Trusted partner for Borewell Solutions
                    </h2>

                    <p className="text-sm md:text-base text-white/85 mb-8 leading-relaxed max-w-2xl mx-auto">
                        Our modern equipment and skilled professionals ensure precise drilling, strong water yield, and dependable results every time.
                    </p>
    ...
    const services = [
        {
            ...
            imageUrl: '/assets/images/services/borewell-drilling.png',
            href: '/services/borewell-drilling'
        },
        {
            title: 'Compressor Work',
            description: [
                'Compressor work to clear blockages inside the borewell.',
                'Compressor work to make water flow smoothly again.'
            ],
            imageUrl: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?q=80&w=2069&auto=format&fit=crop',
            href: '/services/compressor-work'
        },
        {
            title: 'Motor Setup',
            description: [
            ...
            imageUrl: '/assets/images/services/motor-setup.png',
        ...
        },
        {
            ...
            imageUrl: '/assets/images/services/cleaning-services.jpg',
        ...
        <section id="services" className="lg:py-20 py-10 bg-white">
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-[15px] font-medium leading-relaxed opacity-80">
                        We repair damaged borewells and provide regular maintenance to ensure smooth and long-term performance.
                    </p>
                </div>
    ...
    const steps = [
        {
            id: '01',
            title: 'Site Survey',
            description: 'Lorem ipsum dolor sit amet consectetur. Morbi mattis at nisl tortor.',
            icon: Search
        },
        {
            id: '02',
        ...
        <section className="py-20 bg-white overflow-hidden">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-slate-500 mb-16 max-w-2xl mx-auto text-sm">
                    Our step-by-step drilling process ensures quality results and customer satisfaction.
                </p>

                <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full gap-8 md:gap-0">
                    {steps.map((step, index) => (
                        <div key={step.id} className="flex flex-col md:flex-row items-center relative w-full md:w-auto">
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16 text-white">
                    ...
                    <p className="text-white/90 max-w-2xl mx-auto text-base font-medium">
                        We are committed to providing the best borewell drilling services with honest pricing and reliable workmanship.
                    </p>
                </div>
    ...
    const reviews = [
        {
            ...
            rating: 5,
            text: 'Lorem ipsum dolor sit amet consectetur. Consectetur leo gravida commodo et euismod diam malesuada. Commodo velit ut vulputate sed pellentesque malesuada nunc.'
        },
        {
            name: 'Leenisha',
    ...
    return (
        <section className="py-20 bg-slate-50 overflow-hidden relative">
            <div className="container mx-auto px-4 text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 mb-2">Service That Speaks Through Customers</h2>
                <p className="text-slate-500 text-sm">
                    Our services are defined by happy customers and proven results, built on trust, quality, and real customer experiences.
                </p>
            </div>
            ...
            <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_48px,_black_calc(100%-48px),transparent_100%)]">
                ...
                <div className="flex items-center justify-center md:justify-start [&_li]:mx-4 animate-scroll">
                    ...
                    {[...reviews, ...reviews].map((review, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow w-[280px] sm:w-[350px] flex-shrink-0 mx-4"
                        >
            ...
            <div className="absolute top-1/4 left-10 text-blue-200 opacity-50"><Star className="w-8 h-8 rotate-12" /></div>
            <div className="absolute bottom-1/4 right-10 text-blue-200 opacity-50"><Star className="w-10 h-10 -rotate-12" /></div>
        </section>
    );
}
    ...
    return (
        <>
            ...
            <div className="bg-white">
                <img
                    src="/assets/images/Home check banner.png"
