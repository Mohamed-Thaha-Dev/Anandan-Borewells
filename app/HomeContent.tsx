        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-6xl mx-auto space-y-4 text-slate-600 leading-relaxed text-center">
            <p>
              ...
              over 15 years. Founded with a commitment to provide reliable and
            ...
            <p>
              ...
              Today, we have successfully completed over 500 projects across
  ...
  const steps = [
    {
      ...
      title: "Site Survey",
      description:
        "Lorem ipsum dolor sit amet consectetur. Morbi mattis at nisl tortor.",
      icon: Search,
    },
    {
      id: "02",
